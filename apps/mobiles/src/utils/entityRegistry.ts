...
export const CLUBS_REGISTRY: Record<string, ClubMeta> = {
  ...
  'liverpool': {
    ...
    manager: 'Arne Slot',
    position: 1,
    featuredPlayerSlugs: ['mohamed-salah'],
  },
  'manchester-city': {
    id: 50,
    ...
    position: 3,
    featuredPlayerSlugs: ['erling-haaland'],
  },
  'real-madrid': {
    id: 541,
    name: 'Real Madrid CF',
...
export const PLAYERS_REGISTRY: Record<string, PlayerMeta> = {
  'victor-osimhen': {
    ...
    height: '186 cm',
    marketValue: '€75.00M',
    bio: 'Victor Osimhen is a world-class Nigerian striker renowned for his explosive pace, aerial prowess, and lethal finishing.',
    seasonStats: {
      appearances: 22,
      goals: 19,
      assists: 5,
  ...
  'bukayo-saka': {
    ...
    height: '178 cm',
    marketValue: '€140.00M',
    bio: 'Bukayo Saka is Arsenal and England talismanic winger celebrated for his creative vision and decisive goals.',
    seasonStats: {
      appearances: 24,
      goals: 12,
      assists: 14,
  ...
  'mohamed-salah': {
    ...
    height: '175 cm',
    marketValue: '€55.00M',
    bio: 'Mohamed Salah is an iconic Egyptian forward and Premier League record-breaker.',
    seasonStats: {
      appearances: 26,
      goals: 21,
      assists: 15,
  ...
  'erling-haaland': {
    ...
    height: '194 cm',
    marketValue: '€200.00M',
    bio: 'Erling Haaland is a generational striking powerhouse known for athletic dominance and finishing.',
    seasonStats: {
      appearances: 25,
      goals: 24,
      assists: 4,
...
export const MOBILE_TRANSFERS: TransferItem[] = [
  {
    id: 'tr-1',
    ...
    tier: 1,
    competitionSlug: 'premier-league',
    description: 'Arsenal in advanced discussions with Napoli representatives.',
  },
  {
    id: 'tr-2',
    ...
    description: 'Personal terms agreed on 4-year contract.',
  },
  {
    id: 'tr-3',
    ...
    tier: 1,
    competitionSlug: 'premier-league',
    description: 'Official announcement: 5-year contract at Emirates Stadium.',
  },
  {
    id: 'tr-4',
    ...
    description: 'Man City monitoring Wirtz situation.',
  },
];

export const MobileEntityService = {
  getCompetition: (slug: string) => COMPETITIONS_REGISTRY[slug.toLowerCase()],
  getClub: (slug: string) => CLUBS_REGISTRY[slug.toLowerCase()],
  getPlayer: (slug: string) => PLAYERS_REGISTRY[slug.toLowerCase()],
  getAllCompetitions: () => Object.values(COMPETITIONS_REGISTRY),
  getAllClubs: () => Object.values(CLUBS_REGISTRY),
  getAllPlayers: () => Object.values(PLAYERS_REGISTRY),
  getTransfers: () => MOBILE_TRANSFERS,
};
