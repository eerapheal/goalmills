    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <Image
            source={{ uri: player.player_logo || 'https://via.placeholder.com/100' }}
            style={styles.avatar}
          />
          ...
          <View style={styles.statsCard}>
            ...
            <View style={styles.surfaceStats}>
              <Text style={styles.surfaceText}>
                Hard: {currentStats.hard_won}-{currentStats.hard_lost}
              </Text>
              <Text style={styles.surfaceText}>
                Clay: {currentStats.clay_won}-{currentStats.clay_lost}
              </Text>
              <Text style={styles.surfaceText}>
                Grass: {currentStats.grass_won}-{currentStats.grass_lost}
              </Text>
            </View>
          </View>
        )}
