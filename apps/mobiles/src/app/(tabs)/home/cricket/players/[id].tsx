    ...
    if (!player) {
        return (
            <View style={styles.errorContainer}>
                ...
                <Text style={styles.errorSubtext}>Could not retrieve athlete record from the cricket matrix.</Text>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.heroCard}>
                    ...
                    <View style={styles.specsGrid}>
                        ...
                        <View style={styles.specBox}>
                            ...
                            <Text style={styles.specValue}>{player.player_age ? `${player.player_age} yrs` : 'N/A'}</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.formatTabs}>
                    {(['test', 'odi', 't20i', 'ipl'] as FormatTab[]).map((fmt) => (
                        ...
                        >
                            <Text style={[styles.formatTabText, activeFormat === fmt && styles.formatTabTextActive]}>
                                {fmt.toUpperCase()}
                            </Text>
                        </TouchableOpacity>
                    ))}
                ...
                {currentStats ? (
                    <View style={styles.sectionCard}>
                        <Text style={styles.sectionTitle}>🏏 Batting Record ({activeFormat.toUpperCase()})</Text>
                        ...
                        <View style={styles.statsGrid}>
                            ...
                            <View style={[styles.statCell, { backgroundColor: 'rgba(245, 158, 11, 0.15)' }]}>
                                ...
                                <Text style={[styles.statCellValue, { color: '#fbbf24' }]}>{currentStats.runs}</Text>
                            </View>
                            <View style={styles.statCell}>
                            ...
                            <View style={styles.statCell}>
                                ...
                                <Text style={[styles.statCellValue, { color: '#34d399' }]}>{currentStats.average}</Text>
                            </View>
                            <View style={styles.statCell}>
                                <Text style={styles.statCellLabel}>Strike Rate</Text>
                                <Text style={[styles.statCellValue, { color: '#60a5fa' }]}>{currentStats.strikeRate}</Text>
                            </View>
                        </View>
                        ...
                        <View style={[styles.statsGrid, { marginTop: SPACING.sm }]}>
                            <View style={styles.statCell}>
                                ...
                                <Text style={[styles.statCellValue, { color: '#c084fc' }]}>{currentStats.centuries}</Text>
                            </View>
                            <View style={styles.statCell}>
                                <Text style={styles.statCellLabel}>50s</Text>
                                <Text style={[styles.statCellValue, { color: '#60a5fa' }]}>{currentStats.fifties}</Text>
                            </View>
                            <View style={styles.statCell}>
                        ...
                        {currentStats.wickets !== undefined && currentStats.wickets > 0 && (
                            <View style={{ marginTop: SPACING.lg, paddingTop: SPACING.md, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.08)' }}>
                                ...
                                <View style={styles.statsGrid}>
                                    <View style={[styles.statCell, { backgroundColor: 'rgba(34, 211, 238, 0.15)' }]}>
                                        ...
                                        <Text style={[styles.statCellValue, { color: '#22d3ee' }]}>{currentStats.wickets}</Text>
                                    </View>
                                    <View style={styles.statCell}>
                                    ...
                                    <View style={styles.statCell}>
                                        ...
                                        <Text style={styles.statCellValue}>{currentStats.bestBowlingInnings || 'N/A'}</Text>
                                    </View>
                                </View>
                            </View>
                        )}
                        ...
                        {player.recent_matches.map((m, idx) => (
                            <View key={idx} style={styles.recentMatchRow}>
                                <View style={{ flex: 1 }}>
                                    ...
                                    <Text style={styles.recentMatchSub}>vs {m.opponent} • {m.date}</Text>
                                </View>
                                <View style={{ alignItems: 'flex-end' }}>
                                    <Text style={styles.recentMatchScore}>{m.runs} ({m.balls}b)</Text>
                                    {m.wickets !== '0' && (
                                        <Text style={styles.recentMatchWickets}>{m.wickets}</Text>
                                    )}
                                </View>
                            </View>
                        ))}
