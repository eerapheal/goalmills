...
class TennisApi {
  async getCountries(
    params?: Partial<Omit<TennisCountriesParams, 'met'>>
  ): Promise<TennisCountriesResponse> {
    return fetchFromAPI<TennisCountriesResponse>('Countries', (params || {}) as any);
  }

  async getLeagues(
    params?: Partial<Omit<TennisLeaguesParams, 'met'>>
  ): Promise<TennisLeaguesResponse> {
    return fetchFromAPI<TennisLeaguesResponse>('Leagues', (params || {}) as any);
  }

  async getFixtures(
    params?: Partial<Omit<TennisFixturesParams, 'met'>>
  ): Promise<TennisFixturesResponse> {
  ...
  async getLivescore(
    params?: Partial<Omit<TennisLivescoreParams, 'met'>>
  ): Promise<TennisLivescoreResponse> {
    return fetchFromAPI<TennisLivescoreResponse>('Livescore', (params || {}) as any);
  }

  async getStandings(
    params?: Partial<Omit<TennisStandingsParams, 'met'>>
  ): Promise<TennisStandingsResponse> {
    return fetchFromAPI<TennisStandingsResponse>('Standings', (params || {}) as any);
  }

  async getPlayers(
    params?: Partial<Omit<TennisPlayersParams, 'met'>>
  ): Promise<TennisPlayersResponse> {
  ...
  async getLiveOdds(
    params?: Partial<Omit<TennisLiveOddsParams, 'met'>>
  ): Promise<TennisLiveOddsResponse> {
