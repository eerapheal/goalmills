...
class TennisApi {
  async getCountries(params?: Partial<Omit<TennisCountriesParams, 'met'>>): Promise<TennisCountriesResponse> {
    return fetchFromAPI<TennisCountriesResponse>('Countries', (params || {}) as any);
  }

  async getLeagues(params?: Partial<Omit<TennisLeaguesParams, 'met'>>): Promise<TennisLeaguesResponse> {
    return fetchFromAPI<TennisLeaguesResponse>('Leagues', (params || {}) as any);
  }

  async getFixtures(params?: Partial<Omit<TennisFixturesParams, 'met'>>): Promise<TennisFixturesResponse> {
    return fetchFromAPI<TennisFixturesResponse>('Fixtures', (params || {}) as any);
  }

  async getH2H(params?: Partial<Omit<TennisH2HParams, 'met'>>): Promise<TennisH2HResponse> {
    return fetchFromAPI<TennisH2HResponse>('H2H', (params || {}) as any);
  }

  async getLivescore(params?: Partial<Omit<TennisLivescoreParams, 'met'>>): Promise<TennisLivescoreResponse> {
    return fetchFromAPI<TennisLivescoreResponse>('Livescore', (params || {}) as any);
  }

  async getStandings(params?: Partial<Omit<TennisStandingsParams, 'met'>>): Promise<TennisStandingsResponse> {
    return fetchFromAPI<TennisStandingsResponse>('Standings', (params || {}) as any);
  }

  async getPlayers(params?: Partial<Omit<TennisPlayersParams, 'met'>>): Promise<TennisPlayersResponse> {
    return fetchFromAPI<TennisPlayersResponse>('Players', (params || {}) as any);
  }

  async getOdds(params?: Partial<Omit<TennisOddsParams, 'met'>>): Promise<TennisOddsResponse> {
    return fetchFromAPI<TennisOddsResponse>('Odds', (params || {}) as any);
  }

  async getLiveOdds(params?: Partial<Omit<TennisLiveOddsParams, 'met'>>): Promise<TennisLiveOddsResponse> {
    return fetchFromAPI<TennisLiveOddsResponse>('LiveOdds', (params || {}) as any);
  }
}
