...
export function CricketMatchCard({ match, onPress }: CricketMatchCardProps) {
    ...
    const isLive = match.event_live === '1' || match.event_status === 'Live' || match.event_status === 'In Progress';
    const isUpcoming = match.event_status === 'Upcoming' || match.event_status === 'Not Started' || match.event_status === 'Scheduled';
