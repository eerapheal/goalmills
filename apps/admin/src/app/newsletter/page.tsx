  ...
  const handleTestSend = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok || !json.success)
        throw new Error(json.message || 'Failed to dispatch test email');
            ...
            {lists.length > 0 ? (
              lists.map((list) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between text-xs text-slate-400">
                    <span>
                      Subscribers:{' '}
                      <strong className="text-white">{list.subscriberCount || 0}</strong>
                    </span>
              ...
              <div className="col-span-full glass-card p-8 rounded-2xl border border-white/10 text-center space-y-2">
                ...
                <p className="text-xs text-slate-400 max-w-md mx-auto">
                  All new subscribers are automatically indexed into the primary GoalMills master
                  list. Create custom lists to partition specialized broadcasts.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="glass-card p-5 rounded-3xl border border-white/10 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="p-3.5 rounded-xl bg-slate-950/60 border border-white/10 space-y-1">
                ...
                <p className="text-[11px] text-slate-400">
                  Subscribers interested in Premier League, UCL & European Football
                </p>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-950/60 border border-white/10 space-y-1">
                <div className="flex items-center justify-between">
                ...
                <p className="text-[11px] text-slate-400">
                  Subscribers targeted for IPL, Test Matches & ICC Tournaments
                </p>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-950/60 border border-white/10 space-y-1">
                <div className="flex items-center justify-between">
                ...
                <p className="text-[11px] text-slate-400">
                  Subscribers with breaking alert opt-ins & high engagement scores
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6 animate-fade-in">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted">
                Pre-configured responsive layout engines with multi-sport styling and sponsor slot
                containers.
              </p>
            </div>
          </div>
            ...
            {[
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-300 mt-2 leading-relaxed">{tmpl.desc}</p>
                </div>
          ...
          <div className="bg-slate-900 border-t sm:border border-white/15 w-full max-w-4xl rounded-t-3xl sm:rounded-3xl max-h-[94vh] sm:max-h-[90vh] flex flex-col shadow-2xl animate-fade-in overflow-hidden">
            ...
            <div className="p-5 sm:p-6 border-b border-white/10 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-text-muted mt-0.5">
                  Pre-flight deliverability gate, immutable recipient snapshotting & domain traffic
                  shaping
                </p>
              </div>
              <button
