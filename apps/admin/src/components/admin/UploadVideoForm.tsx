...
export default function UploadVideoForm({ onSuccess }: UploadVideoFormProps = {}) {
  ...
  return (
    <div className="glass-card p-6 rounded-2xl h-fit">
      ...
      {message && (
        <div
          className={`p-4 rounded-lg mb-4 text-sm font-bold ${message.type === 'success' ? 'bg-green-500/20 text-green-300 border border-green-500/50' : 'bg-red-500/20 text-red-300 border border-red-500/50'}`}
        >
          {message.text}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) => {
                ...
                if (
                  (newUrl.includes('youtube.com/watch?v=') && newUrl.length > 30) ||
        ...
        {uploading && (
          <div className="text-xs text-blue-400 animate-pulse">Uploading thumbnail...</div>
        )}
