                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Your ultimate destination for real-time live scores, deep match analytics, and expert sports insights across Football, Cricket, NBA, and Tennis.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-400 text-sm">
                            <li><Link href="/football" className="hover:text-blue-400 transition-colors">Football</Link></li>
                            <li><Link href="/cricket" className="hover:text-blue-400 transition-colors">Cricket</Link></li>
                            <li><Link href="/basketball" className="hover:text-blue-400 transition-colors">Basketball (NBA)</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-400 text-sm">
                            ...
                            <li><Link href="/news" className="hover:text-blue-400 transition-colors">Latest News</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-400 text-sm">
                            ...
                            <li><Link href="/data-deletion" className="hover:text-blue-400 transition-colors">Data Deletion</Link></li>
                        </ul>
                    </div>
                </div>
