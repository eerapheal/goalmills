  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-12 bg-surfaceHighlight/30 py-3 px-4 border-b border-white/10 text-xs font-bold text-text-muted uppercase tracking-wider">
        ...
        <div className="col-span-4 sm:col-span-3 pl-2">Team</div>
        ...
        <div className="col-span-4 sm:col-span-2 text-center">Form</div>
      ...
      <div className="divide-y divide-white/5">
        {standings.map((standing, index) => (
          ...
          >
            ...
            {/* Team */}
            <div className="col-span-4 sm:col-span-3 pl-2 flex items-center min-w-0">
              <Link
                href={`/football/teams/${standing.team.id}`}
              ...
              >
                ...
                <span
                  className={`text-sm font-semibold truncate ${standing.rank <= 4 ? 'text-white' : 'text-text-primary'}`}
                >
                  {standing.team.name}
                </span>
              </Link>
            ...
            <div className="col-span-1 text-center text-sm text-text-muted hidden sm:block">
              {standing.all.win}
            </div>
            <div className="col-span-1 text-center text-sm text-text-muted hidden sm:block">
              {standing.all.draw}
            ...
            <div
              className={`col-span-1 text-center text-sm font-medium hidden sm:block
            ...
            {/* Points */}
            <div className="col-span-2 sm:col-span-1 text-center text-sm font-bold text-white">
              {standing.points}
            </div>
          </div>
        ))}
