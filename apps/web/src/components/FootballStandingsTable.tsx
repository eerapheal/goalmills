        ...
        <div className="w-full bg-surface/50 backdrop-blur-sm rounded-2xl overflow-hidden">
            ...
            <div className="grid grid-cols-12 bg-white/[0.03] py-4 px-6 border-b border-white/5 text-[10px] font-black text-text-muted uppercase tracking-[0.2em]">
                ...
                <div className="col-span-11 grid grid-cols-11 items-center">
                    <div className="col-span-5 sm:col-span-4 pl-4">Club</div>
                    ...
                    <div className="col-span-2 sm:col-span-1 text-center text-secondary font-black">Pts</div>
                </div>
            </div>
                ...
                {standings.map((standing, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="col-span-11 grid grid-cols-11 items-center">
                                {/* Team */}
                                <div className="col-span-5 sm:col-span-4 pl-4 flex items-center min-w-0">
                                    <Link href={`/teams/${standing.team_key}`} className="flex items-center min-w-0 hover:scale-[1.02] transition-transform origin-left">
                                        <div className="relative w-8 h-8 mr-4 shrink-0 p-1 bg-white/5 rounded-lg border border-white/10 group-hover:border-white/20 transition-colors">
                                            <Image src={logo} alt={standing.standing_team} width={32} height={32} className="object-contain w-full h-full" />
                                        </div>
                                        <span className={`text-sm font-bold truncate ${rank <= 4 ? 'text-white' : 'text-text-primary group-hover:text-white'}`}>
                                ...
                                {/* Stats */}
                                <div className="col-span-1 text-center text-sm font-medium text-text-secondary">{standing.standing_P}</div>
                                ...
                                <div className={`col-span-1 text-center text-sm font-bold hidden sm:block
                                ...
                                {/* Points */}
                                <div className="col-span-2 sm:col-span-1 text-center text-base font-black text-white group-hover:text-secondary transition-colors">
