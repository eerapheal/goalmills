...
export function SportsPulseNewsSection() {
    ...
    const [activeCategory, setActiveCategory] = useState<'all' | 'football' | 'cricket' | 'basketball' | 'tennis'>('all');
    ...
    const trendingArticles = [
        {
            ...
            excerpt: 'How elite managers are manipulating midfield overloads and half-space runs in this year\'s knockout stages.',
            category: 'football',
        ...
        },
        {
            ...
            excerpt: 'An analytical deep dive into modern T20 boundary percentages and bowler release angle variations.',
            category: 'cricket',
        ...
        },
        {
            ...
            excerpt: 'Analyzing the top 5 perimeter defenders shutting down scoring champions in the final two minutes.',
            category: 'basketball',
        ...
        },
        {
            ...
            excerpt: 'How top-ranked players adjust their court positioning and topspin RPM between hardcourt and clay.',
            category: 'tennis',
            categoryName: 'Tennis',
            readTime: '4 min read',
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
                            The Sports <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500">Pulse & Headlines</span>
                        </h2>
                        <p className="mt-2 text-sm md:text-base text-slate-400 max-w-xl">
                            Curated matchday analysis, statistical deep dives, and instant video recaps from around the sporting world.
                        </p>
                    </div>
                            ...
                            >
                                <div className="flex flex-wrap items-center justify-between gap-2 mb-2.5">
                                    <div className="flex items-center gap-2">
                                        <span className={`text-[11px] font-bold px-2.5 py-0.5 rounded-md border ${article.tagColor}`}>
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-black uppercase tracking-wider text-white">Video Highlights</span>
                                </div>
                            ...
                            <div className="relative aspect-video rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 mb-4 flex items-center justify-center group-hover:border-blue-500/40 transition-colors">
                                ...
                                <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-[11px] font-semibold text-slate-300 z-10">
                                    ...
                                    <span className="bg-black/70 px-2 py-0.5 rounded text-[10px] font-mono">08:42</span>
                                </div>
                            </div>

                            <p className="text-xs text-slate-300 leading-relaxed">
                                Missed the action? Watch official goals, highlight reels, and post-match breakdowns in crisp high definition.
                            </p>
                        </Link>
                        ...
                        <div className="bg-gradient-to-br from-slate-900/90 via-blue-950/40 to-slate-900/90 backdrop-blur-xl border border-blue-500/20 rounded-3xl p-6 sm:p-7 shadow-2xl relative">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-400">Exclusive tactical previews & lineup alerts</p>
                                </div>
                            </div>

                            <p className="text-xs text-slate-300 leading-relaxed mb-4">
                                Get confirmed team lineups 60 minutes before kickoff, key injury updates, and AI value picks delivered to your inbox every morning.
                            </p>
