      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-slate-900 border border-white/10 rounded-3xl p-8 sm:p-12 shadow-2xl space-y-8 text-slate-200 print:bg-white print:border-0 print:shadow-none print:p-6 print:text-black">
          ...
          <div className="space-y-4 leading-relaxed text-sm">
            ...
            <p>
              This appointment is intended to develop you into a capable member of the GoalMills
              sports media and digital publishing team. Your role will combine structured training
              with practical daily responsibilities in sports journalism, content creation, social
              media management, audience engagement, graphics, publishing, and digital audience
              growth.
            </p>
            <p>
              Your employment will begin with a structured 30-day GoalMills Sports Media Training
              Programme, during which you will learn and immediately apply the skills required for
              your position.
            </p>
          </div>
          ...
          <div className="space-y-6 text-sm divide-y divide-white/10 print:divide-gray-300">
            ...
            <div className="pt-4 space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-slate-300 print:text-gray-800 text-xs sm:text-sm">
                <li>
                  <strong>Job Title:</strong> {data.position}
                </li>
                <li>
                  <strong>Department:</strong> {data.department}
                </li>
                <li>
                  <strong>Employment Start Date:</strong> {data.startDate}
                </li>
                <li>
                  <strong>Initial Training Period:</strong> {data.trainingPeriod}
                </li>
                <li>
                  <strong>Work Arrangement:</strong> {data.workArrangement}
                </li>
                <li>
                  <strong>Reports To:</strong> {data.reportsTo}
                </li>
                <li>
                  <strong>Primary Platform:</strong> GoalMills website and official social media
                  platforms
                </li>
              </ul>
            </div>
            ...
            {/* Clause 2 */}
            <div className="pt-4 space-y-2">
              <h3 className="font-extrabold text-white text-base print:text-black">
                2. TRAINING PERIOD
              </h3>
              <p className="text-slate-300 print:text-gray-800">
                Your first month will be a structured 30-day practical training and onboarding
              ...
              <p className="text-xs text-slate-300 print:text-gray-800">
                The training covers: Sports article writing, Sports research & Fact-checking,
                Journalism & editorial standards, SEO, Content planning, Breaking-news coverage,
                Matchday coverage, Social media, Community management, Canva graphic design,
                Short-form video (Reels, TikTok, Shorts), YouTube, Facebook, X, Audience growth,
                Analytics, Content repurposing, and GoalMills newsroom operations.
              </p>
            </div>
            ...
            <div className="pt-4 space-y-2">
              ...
              <p className="text-slate-300 print:text-gray-800">
                For the initial 30-day training period:{' '}
                <strong className="text-white print:text-black">
                  Training Salary: ₦{data.trainingSalary.toLocaleString()}
                </strong>
                . This amount will be paid for the first month of training. The training period is
                paid employment and not an unpaid internship.
              </p>
            </div>

            <div className="pt-4 space-y-2">
              <h3 className="font-extrabold text-white text-base print:text-black">
                4. STARTING SALARY AFTER TRAINING
              </h3>
              <p className="text-slate-300 print:text-gray-800">
                Following successful completion of the initial training period, your starting salary
                will be:{' '}
                <strong className="text-white print:text-black">
                  ₦{data.startingSalary.toLocaleString()} per month
                </strong>
                .
              </p>
            </div>
            ...
            <div className="pt-4 space-y-2">
              <h3 className="font-extrabold text-white text-base print:text-black">
                5. FUTURE SALARY REVIEW
              </h3>
              <p className="text-slate-300 print:text-gray-800">
                GoalMills is an early-stage sports media business. Once GoalMills begins generating
                sustainable revenue through advertising, sponsorships, partnerships, and
                monetization, management intends to review employee compensation and renegotiate the
                salary accordingly.
              </p>
            </div>
            ...
            <div className="pt-4 space-y-2">
              <h3 className="font-extrabold text-white text-base print:text-black">
                16. DAILY REPORTING & STAND-UP
              </h3>
              <p className="text-slate-300 print:text-gray-800">
                At the end of each working day, you must submit your daily content report including
                published articles, social posts, Canva graphics, video links, sources, problems
                encountered, and lessons learned.
              </p>
              <p className="text-slate-300 print:text-gray-800">
                You are required to attend the GoalMills daily newsroom stand-up from{' '}
                <strong className="text-white print:text-black">
                  5:00 PM – 5:30 PM West Africa Time (WAT)
                </strong>{' '}
                on Google Meet.
              </p>
            </div>
            ...
            <div className="pt-4 space-y-2">
              <h3 className="font-extrabold text-white text-base print:text-black">
                18. 100% WEIGHTED PERFORMANCE EVALUATION
              </h3>
          ...
          <div className="pt-8 border-t-2 border-white/20 grid grid-cols-1 sm:grid-cols-2 gap-8 print:border-black">
            ...
            <div className="space-y-3 bg-slate-950/40 p-5 rounded-2xl border border-white/5 print:bg-transparent print:border-0 print:p-0">
              ...
              <div className="space-y-1 text-sm">
                <p>
                  <strong>Name:</strong> {data.founderName}
                </p>
                <p>
                  <strong>Position:</strong> {data.founderPosition}
                </p>
                ...
                <p className="text-xs text-text-muted print:text-gray-700">
                  Date: {data.founderSignatureDate}
                </p>
              </div>
            </div>
              ...
              {data.isAccepted ? (
                ...
                <div className="space-y-3 print:hidden">
                  <p className="text-xs text-text-muted">
                    Sign below to confirm your acceptance of this appointment and agree to the
                    GoalMills training terms.
                  </p>
                  ...
                  <form onSubmit={handleSignSubmit} className="space-y-3">
                    <label className="flex items-start gap-2 cursor-pointer">
                      ...
                      <span className="text-xs text-slate-300">
                        I confirm that I have read, understood, and accept the terms of this
                        Employment & Training Appointment Letter.
                      </span>
                    </label>
