...
export default function AdminHandbookPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-white p-3.5 sm:p-6 pt-[80px] sm:pt-[95px] print:p-0 print:pt-0 print:bg-white print:text-black">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Admin Navigation Bar - Hidden on Print */}
