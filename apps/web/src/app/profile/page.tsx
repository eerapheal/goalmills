                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex flex-col items-center gap-4 mb-8">
                            ...
                            <div className="text-center">
                                ...
                                {uploading && <p className="text-blue-400 text-xs mt-1 animate-pulse">Uploading...</p>}
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Username</label>
                                <input
                                    type="text"
                                    value={username}
                            ...
                            <div>
                                <label className="block text-slate-400 text-xs font-bold uppercase tracking-widest mb-2">Email</label>
                                <input
                                    type="email"
