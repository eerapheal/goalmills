            ...
            <div className="max-w-4xl mx-auto glass-card rounded-2xl overflow-hidden animate-fade-in relative">
                ...
                <div className="relative pt-12 px-8 flex flex-col md:flex-row items-center md:items-end gap-8 pb-8 border-b border-white/5">
                    ...
                    <div className="flex flex-col items-center p-4 bg-surfaceHighlight/30 rounded-xl backdrop-blur-md">
                        <span className="text-sm text-text-muted uppercase tracking-wider font-bold">Rating</span>
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/5 pb-2">Personal Info</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white mb-4 border-b border-white/5 pb-2">Season Stats</h2>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="glass-card p-4 rounded-xl text-center">
                                <span className="text-3xl font-black text-blue-400">{player.player_assists || 0}</span>
                            ...
                            <div className="glass-card p-4 rounded-xl text-center">
                                <span className="text-3xl font-black text-yellow-400">{player.player_yellow_cards}</span>
