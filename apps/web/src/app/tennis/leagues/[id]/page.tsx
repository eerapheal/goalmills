        ...
        <div className="min-h-screen bg-[#0a0e27] pt-[90px] pb-10">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-sm font-bold text-text-muted uppercase tracking-wider">Tournament Details</span>
                </div>
                ...
                <div className="glass-card rounded-2xl p-8 mb-8 text-center border border-white/5">
                    ...
                    {league.league_surface && (
                        <p className="text-sm text-text-secondary uppercase tracking-wider">{league.league_surface}</p>
                    )}
                </div>
                ...
                {standings.length > 0 && (
                    <div className="mb-8">
                        <h2 className="text-2xl font-bold text-white mb-4 pl-2 border-l-4 border-yellow-500">🏆 Standings</h2>
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <tbody>
                                    {standings.map((player) => (
                                        <tr key={player.player_key} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                            ...
                                            <td className="p-4">
                                                ...
                                                >
                                                    <span className="font-bold text-white group-hover:text-yellow-500 transition-colors">{player.player}</span>
                ...
                {/* Fixtures Section */}
                <div>
                    <h2 className="text-2xl font-bold text-white mb-4 pl-2 border-l-4 border-yellow-500">📅 Upcoming Matches</h2>
                    {fixtures.length > 0 ? (
                        fixtures.map(match => (
