        ...
        <div className="glass-card rounded-[2.5rem] p-6 md:p-10 border border-white/5 relative overflow-hidden">
          <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/5">
            <h2 className="text-lg font-black text-white uppercase tracking-tight flex items-center gap-3">
              ...
              {activeGender.toUpperCase()}&apos;S {activeFormat.toUpperCase()}{' '}
                    ...
                    return (
                      ...
                      >
                        <td className="py-4 px-4 text-center">
                          <span
                            className={`inline-flex items-center justify-center w-7 h-7 rounded-xl border text-xs font-black tabular-nums ${rankColor}`}
                          >
                            {item.rank}
                          </span>
                        </td>
