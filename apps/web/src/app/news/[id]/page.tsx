...
export default async function NewsDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen bg-slate-950 pt-[80px] pb-12">
                        ...
                        <div className="flex flex-wrap items-center gap-4 md:gap-6 text-slate-400 text-xs md:text-sm font-bold uppercase tracking-wider">
                            ...
                            {article.source && (
                                <>
                                    <span className="hidden md:inline opacity-30">•</span>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.828a4 4 0 015.656 0l4 4a4 4 0 01-5.656 5.656l-1.1-1.1" /></svg>
