                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {player.player_points_per_game && (
                            <div className="bg-white/5 rounded-lg p-4">
                                ...
                                <p className="text-2xl font-bold text-yellow-500">{player.player_points_per_game}</p>
                            </div>
                        )}
                        {player.player_rebounds_per_game && (
                            <div className="bg-white/5 rounded-lg p-4">
                                <p className="text-xs text-text-muted mb-1">Rebounds Per Game</p>
                                <p className="text-2xl font-bold text-yellow-500">{player.player_rebounds_per_game}</p>
                            </div>
                        )}
                        {player.player_assists_per_game && (
                            <div className="bg-white/5 rounded-lg p-4">
                                <p className="text-xs text-text-muted mb-1">Assists Per Game</p>
                                <p className="text-2xl font-bold text-yellow-500">{player.player_assists_per_game}</p>
                            </div>
                        )}
                        {player.player_field_goal_percentage && (
                            <div className="bg-white/5 rounded-lg p-4">
                                <p className="text-xs text-text-muted mb-1">FG%</p>
                                <p className="text-2xl font-bold text-yellow-500">{player.player_field_goal_percentage}%</p>
                            </div>
                        )}
                        {player.player_three_point_percentage && (
                            <div className="bg-white/5 rounded-lg p-4">
                                <p className="text-xs text-text-muted mb-1">3P%</p>
                                <p className="text-2xl font-bold text-yellow-500">{player.player_three_point_percentage}%</p>
                            </div>
                        )}
                        {player.player_free_throw_percentage && (
                            <div className="bg-white/5 rounded-lg p-4">
                                <p className="text-xs text-text-muted mb-1">FT%</p>
                                <p className="text-2xl font-bold text-yellow-500">{player.player_free_throw_percentage}%</p>
                            </div>
                        )}
                    </div>
                </div>
