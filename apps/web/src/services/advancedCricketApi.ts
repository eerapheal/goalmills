...
const CRICKET_PLAYERS_DATABASE: CricketPlayer[] = [
  {
    ...
    recent_matches: [
      {
        match_id: 'm1',
        match_name: 'IND vs AUS - 3rd Test',
        date: '2026-02-15',
        runs: '84 & 42',
        balls: '152',
        wickets: '0',
  ...
  },
  {
    ...
    recent_matches: [
      {
        match_id: 'm8',
        match_name: 'AUS vs IND - 3rd Test',
        date: '2026-02-15',
        runs: '38 & 14',
        balls: '68',
        wickets: '4/62 & 2/45',
...
const CRICKET_NEWS_FEED: CricketNewsItem[] = [
  {
    ...
    summary:
      'The BCCI has unveiled the 74-match schedule for IPL 2026 featuring 10 elite franchises battling across 12 venues with enhanced tactical impact player rules.',
    content:
      'The world’s premier T20 franchise competition returns with blockbuster rivalries. Defending champions Kolkata Knight Riders will host Sunrisers Hyderabad in the opening spectacle at Eden Gardens.',
  ...
  },
  {
    ...
    summary:
      'With decisive series wins, Australia and India hold the top two spots on the WTC 2025-2027 league table, closely trailed by England and South Africa.',
    content:
      'The points percentage table has tightened as the championship approaches its climax. India’s dominant home performances combined with Australia’s away victories set the stage for an electrifying final sprint.',
  ...
  },
  {
    ...
    summary:
      'An in-depth statistical analysis on how powerplay batting metrics and boundary percentage have shifted the median T20 total past 210 runs.',
    content:
      'Top teams across international cricket and franchise leagues now prioritize high-impact boundaries over traditional anchor roles, unlocking historic scoring records in modern cricket history.',
    image: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?q=80&w=800',
...
export const advancedCricketApi = {
    ...
    try {
      ...
      return {
        ...
        result: [
          ...
          {
            league_key: '9683',
            league_name: 'Pakistan Super League (PSL)',
            league_year: '2026',
            league_season: '2026',
          ...
          {
            league_key: '9930',
            league_name: 'Women’s Premier League (WPL)',
            league_year: '2026',
            league_season: '2026',
            country_name: 'India',
          },
          {
            ...
            league_year: '2025-2027',
            league_season: '2025-2027',
            country_name: 'International',
          },
        ],
      };
      ...
      const mockFixtures: CricketEvent[] = [
        {
          ...
          scorecard: {
            ...
            'Australia 1st Innings': [
              {
                innings: 'Australia 1st Innings',
                player: 'Travis Head',
                type: 'Batsman',
                status: 'c Rahul b Bumrah',
                R: '88',
                B: '64',
                Min: '82',
                '4s': '10',
            ...
            'Australia 1st Innings': [
              {
                ...
                ended: 'No',
                runs: '1',
                post: 'Bumrah nails a pin-point yorker on middle stump. Cummins digs it out to long-on for a single.',
              },
              {
                innings: 'Australia 1st Innings',
                balls: '44.1',
                ...
                ended: 'No',
                runs: '4',
                post: 'FOUR! Slower ball dispatched through extra cover with fierce timing by Cummins!',
              },
              {
                innings: 'Australia 1st Innings',
                balls: '43.6',
                ...
                ended: 'Yes',
                runs: 'W',
                post: 'OUT! CAUGHT! Maxwell goes for the reverse sweep against Kuldeep and top-edges it straight to Jadeja at backward point! Huge breakthrough!',
              },
              {
                innings: 'Australia 1st Innings',
                balls: '43.5',
                ...
                ended: 'No',
                runs: '6',
                post: 'SIX! Maxwell launches Kuldeep deep into the top tier over deep midwicket!',
              },
            ],
          },
        },
  ...
  getLivescore: async (
    ...
    try {
      ...
      const live = fixtures.result.filter(
        (m) => m.event_live === '1' || m.event_status === 'In Progress'
      );
      ...
      const fullEvent: CricketEvent = {
        ...
        event_home_team_logo:
          ...
          (header.team1?.imageId
            ...
            : `https://ui-avatars.com/api/?name=${encodeURIComponent(header.team1?.name || baseMatch?.event_home_team || 'Home')}&background=0D8ABC&color=fff&size=128&bold=true`),
        event_away_team_logo:
          ...
          (header.team2?.imageId
            ...
            : `https://ui-avatars.com/api/?name=${encodeURIComponent(header.team2?.name || baseMatch?.event_away_team || 'Away')}&background=0D8ABC&color=fff&size=128&bold=true`),
        ...
        result: [
          {
            team_key: '1',
            team_name: 'India',
            team_logo: 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?q=80&w=200',
          },
          {
            team_key: '2',
            team_name: 'Australia',
    ...
    try {
      ...
      if (params?.search) {
        ...
        filtered = filtered.filter(
          (p) =>
            p.player_name.toLowerCase().includes(q) || p.player_country?.toLowerCase().includes(q)
        );
      }
  ...
  getPlayerById: async (playerId: string | number): Promise<CricketPlayer | null> => {
    try {
      ...
      const dbFound = CRICKET_PLAYERS_DATABASE.find(
        (p) => String(p.player_key) === String(playerId)
      );
  ...
  getNews: async (category?: string): Promise<CricketNewsItem[]> => {
    try {
      ...
      return CRICKET_NEWS_FEED.filter((n) =>
      ...
      if (Array.isArray(list) && list.length > 0) {
        return list.map((p: any) => ({
          ...
          player_image: p.faceImageId
            ? `https://static.cricbuzz.com/a/img/v1/i1/c${p.faceImageId}/i.jpg`
            : p.player_image,
        }));
      }
    } catch (e) {
    ...
    try {
      ...
      if (Array.isArray(newsList) && newsList.length > 0) {
        return newsList.map((item: any, idx: number) => ({
          ...
          summary:
            item.story?.intro || item.summary || 'Player performance and series projections.',
          image: item.story?.imageId
            ? `https://static.cricbuzz.com/a/img/v1/i1/c${item.story.imageId}/i.jpg`
    ...
    try {
      ...
      if (Array.isArray(rawList) && rawList.length > 0) {
        return rawList.map((t: any) => ({
          ...
          team_logo: t.imageId
            ? `https://static.cricbuzz.com/a/img/v1/i1/c${t.imageId}/i.jpg`
            : t.team_logo,
        }));
      }
    } catch (e) {
